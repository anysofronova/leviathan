...
export const SyntheticImage = ({ src, ...props }: ImageWithStateProps): JSX.Element => {
  ...
  return (
    <div>
      {loading && (
        <div className='flex'>
          <div className='flex h-[100%] w-full items-center justify-center rounded bg-gray-300 dark:bg-gray-700 sm:w-96'>
            <svg
